...
const LovedThisContent = ({
  loveDesSty = "max-lg:text-start text-black-33 max-lg:mb-5 max-lg:text-center text-base max-w-[570px] font-medium",
}) => {
  return (
    <div className="bg-yellow-100 py-6 lg:py-8 rounded-[14px]">
      <div className="container lg:flex lg:gap-8 items-center">
        <div className="">
          <h4 className="text-[28px] font-medium text-black-33 mb-4 leading-8 max-lg:text-start">
            Loved this content?
          </h4>
