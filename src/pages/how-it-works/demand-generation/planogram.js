...
import {
  ...
  planogramBanner,
  schemaListItem,
} from "@/static/json/demandGeneration/planogram";
...
const Planogram = () => {
  ...
  return (
    <>
      ...
      <CardSection
        ...
        renderElement={() => (
          <div className="grid grid-cols-3 gap-8">
            {planogramBenefits?.cardDataList?.map(
              (item, index) => {
                return (
      ...
      <CardSection
        ...
        renderElement={() => (
          <div className="grid gap-4 lg:gap-3 lg:grid-cols-4">
            {planogramLeverage?.cardData?.map(
              (item, index) => {
                return (
      ...
      />
      <HyperlocalSection {...planogramHyperlocal} />
