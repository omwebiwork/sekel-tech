...
export const discoveryFeature = {
  sectionData: { title: "Discovery Feature", description: null },
  cardData: [
    {
    ...
    },
    {
      ...
      cardSty: "px-10 pt-10 rounded-2xl h-full bg-gray-100 pb-[20px]",
...
export const advantagesOfSekel = {
  sectionData: {
