...
export const beyondSlider = {
  sectionData: {
    title: "Going Beyond - Growing Bigger",
    description:
      "The power of lead management system at scale - all in one app",
  },
  listData: [
    {
      image: {
...
export const chooseSellrApp = {
  sectionData: {
    title: "Why Choose SellrApp?",
    description: ` Elevate your business effortlessly with SellrApp. Lead management,
  ...
  contanierImage: "/seller-app-1.png",
};
