export const bannerCareers = {
  ...
  description:
    "We believe that by working together, we can achieve more than the sum of our individual efforts. Quoting the great Johan Cruyff, “Alone you can do so little; together you can do so much.”",
  image: {
    src: "/team.png",
    alt: "img",
    height: 800,
...
export const weCommunicate = {
  ...
  ourPerks: {
    title: "Our Perks",
    subheadTitle:
      "At Sekel Tech, We also prioritise taking care of our employees’ health and well-being. That’s why we have a minimum leave policy instead of a maximum.",
    description:
