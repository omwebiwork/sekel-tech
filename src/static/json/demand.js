...
export const demandGenerationFeature = {
  sectionData: {
...
export const demandGenerationReimagined = {
  sectionData: {
...
export const masterLocalAdvertising = {
  sectionData: {
    title: "Master Local Advertising",
    description: "Sekel Tech’s Demand Generation Platform",
  },
  renderElementContent: {
    image: { src: "/advertising.png", height: 500, width: 500, alt: "img" },
    contentText: `Revolutionize your local discovery strategy with Sekel’s Demand
    Generation Platform, turbocharging your brand’s presence and
    customer connections`,
  },
};

export const sekelsWayToMaster = {
  sectionData: {
...
export const mediaPlanning = {
  sectionData: {
    ...
    description:
      "Strategic Media Planning with Sekel Tech’s Demand Generation Platform for Leading Brands",
  },
  renderElement: {
    cardData: [
      {
    ...
    image: { src: "/meeting-data.png", height: 489, width: 599, alt: "img" },
    text: `By following these tips, you can create effective media
