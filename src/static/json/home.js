...
export const discoveryCardData = [
  ...
  },
  {
    ...
    description:
      "We come with in-built CDP, CRM, DMS, ePoS. Making sure all your dealers, products, and leads data are captured, seamlessly integrating it with your CRM, DMS, CDP, LMS for effortless data flow and management. ",
    image: {
      src: "/play-data.gif",
    },
    slug: "/data",
