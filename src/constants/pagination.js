...
export const createPaginationLinks = ( currentPage, totalPages ) => {
	...
	// Push last and second last index item in the array if it does not already exists.
	if ( (totalPages - 1) && (-1 === paginationArray.indexOf( totalPages -1 )) ) {
...
export const createMobilePaginationLinks = ( currentPage, totalPages ) => {
	const paginationArray = [];
	let countOfDotItems = 0;
